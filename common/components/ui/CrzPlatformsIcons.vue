...
import CrzPlatformIcon from '@/common/components/ui/CrzPlatformIcon.vue'
import { platformsIcons } from '@/common/components/ui/platforms-icons'
import type { tPlatformsIcons } from '@/common/components/ui/platforms-icons'
