...
import CrzBadge from '@/common/components/ui/CrzBadge.vue'
...
import { type GamePaidAndOwnedStatus, ProductService } from '~/common/core/services/ProductService'
import type GameModel from '~/common/core/models/GameModel'
import type { ExtendedGameModel } from '~/types/ExtendedGameModel'
