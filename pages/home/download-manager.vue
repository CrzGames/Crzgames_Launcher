...
import { ref } from 'vue'
import type { ActiveDownloadGame, CompleteDownloadGame } from '@/stores/downloads.store'
import { useDownloadsStore } from '@/stores/downloads.store'
import ActiveDownloadCard from '@/components/cards/ActiveDownloadCard.vue'
import CompleteDownloadCard from '@/components/cards/CompleteDownloadCard.vue'
import CrzConfirmModal from '@/common/components/modals/CrzConfirmModal.vue'
